...
const Tags = () => {
    const tagsList = [{
        ...
        },
        {
            id: 12,
            tagName: "mongodb",
            tagDesc: "MongoDB is a scalable, high-performance, open source, document-oriented NoSQL database. It supports a large number of languages and application development platforms",
        },
    ];
